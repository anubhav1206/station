...
// generated:  Mon Aug  8 01:14:16 CEST 2022
...
<html>
	...
	<body>
		<nav class="navbar navbar-expand-lg navbar-dark">
			<div class="container">
			  <a class="navbar-brand" href="#"><img src="./logo_banner.webp" class="massa-logo-banner" alt="Massa logo" /></a>
			  <h2>Thyra</h1>
			  ...
			  <div class="collapse navbar-collapse justify-content-end " id="navbarNav">
				<ul class="navbar-nav ">
				  <li class="nav-item">
					<a class="nav-link "  href="http://wallet.mythyra.massa/wallet.html">Wallet</a>
				  </li>
				  <li class="nav-item">
		...
		<div class="container">
					...
					<div id="create-form ">
						...
						<div class="form-floating mb-4">
							<input
								...
								type="text"
							/>
							<label for="websiteDescription">Website Name</label>
						</div>
					</div>
				</div>
				<div class='col-6'>
					<select id="wallet-select" class="form-select" aria-label="Default select example">
			...
			<div class='row justify-content-md-center mt-5'>
				<div class='col'>
					<button id="create-sc" onClick='deployWebsiteDeployerSC()' class="primary-button me-5" id='buttonid' type='button' value='Upload MB' >Create SC</button>
